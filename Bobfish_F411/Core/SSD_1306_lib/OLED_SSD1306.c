...
static uint8_t _buffer[SSD1306_LCDHEIGHT * SSD1306_LCDWIDTH / 8];
...
void SSD1306_Clear(uint8_t Color)
{
	...
	{
		case WHITE:
			memset(_buffer, 0xFF, (SSD1306_LCDHEIGHT * SSD1306_LCDWIDTH / 8));
			break;
		case BLACK:
			memset(_buffer, 0x00, (SSD1306_LCDHEIGHT * SSD1306_LCDWIDTH / 8));
			break;
	}
}
